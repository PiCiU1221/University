...
int main(int argc, char* argv[]) {
    ...
    #pragma omp parallel sections
    {
        #pragma omp section
        {
            matrix_a = loadMatrixFromFile(matrix_a_filename, rows_a, cols_a);
        }
        
        #pragma omp section
        {
            matrix_b = loadMatrixFromFile(matrix_b_filename, rows_b, cols_b);
        }
    }
    ...
    cout << "Matrix multiplication completed in " << elapsed_time << " seconds." << std::endl;
